...
ViewFrustumSceneObject::ViewFrustumSceneObject(const int numCascade, const GLuint fsFunctionHandle,
                                               const int pixelProcessFuncBinding) : NUM_CASCADE(numCascade)
{
