...
std::string Shader::shaderInfoLog() const
{
    return this->m_shaderInfoLog;
}

ShaderStatus Shader::status() const
{
    return this->m_shaderStatus;
}
...
ShaderProgramStatus ShaderProgram::status() const
{
    return this->m_shaderProgramStatus;
}
